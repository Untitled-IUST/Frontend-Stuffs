...
function LoginBarber(){
  ...
  const handleLogin = (event) => {
    ...
    .then((res) => {
      ...
      localStorage.setItem('LoginChecker','1');
            ...
            <div className="w-full lg:w-1/2 rounded-lg lg:rounded-l-none flex flex-col justify-center">
              ...
              <form className="mx-8 mt-6 mb-4 rounded">
                <div className="mb-4">
                  ...
                  <p className="font-bold m-1 text-xs italic text-MediumRuby-500">{typeof emailAddressError ==='object' &&  (<React.Fragment><ErrorIcon fontSize="small"/><span>{emailAddressError}</span></React.Fragment>)}</p>
                </div>
                <div className="relative mb-4">
                  ...
                  <div className="flex">
                    ...
                    <button
                        type="button"
                        className="border-DesertSand-500 bg-DesertSand-500 rounded-r text-AteneoBlue-500 flex items-center px-2"
                  ...
                  <p className="font-bold text-xs italic text-MediumRuby-500">{typeof passwordError  ==='object' &&  (<React.Fragment><ErrorIcon fontSize="small"/><span>{passwordError}</span></React.Fragment>)}</p>
                </div>
                ...
                <p className="font-bold m-1 text-xs italic text-MediumRuby-500">{typeof Error  ==='string' && LoginLoading === false &&  (<React.Fragment><ErrorIcon fontSize="small"/><span>{Error}</span></React.Fragment>)}</p>

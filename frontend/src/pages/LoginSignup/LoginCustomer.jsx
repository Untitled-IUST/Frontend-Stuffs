              ...
              <form className="mx-8 mt-6 mb-4 rounded">
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="bg-charcoal-500 border-2 border-gray-400 focus:border-Mauve-700 w-full pl-10 py-2 text-base leading-tight text-Mauve-700 rounded appearance-none focus:outline-none"
                      id="Email"
                      type="email"

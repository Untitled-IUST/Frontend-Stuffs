  ...
  return(
    <div className=" bg-WhiteChocolate-500 min-h-screen flex flex-col justify-center">
      <div className="max-w-[800px] container mx-auto">
          <h3 className="text-AteneoBlue-500 font-bold text-2xl text-center">Edit Password</h3>
          <div className="rounded-lg bg-DesertSand-500">
            <form className="mx-8 mt-6 pt-3 pb-1 rounded">
              ...
              <Link to="/ProfilePage" className="hover:bg-AteneoBlue-600 mb-2 bg-AteneoBlue-500 py-2.5 rounded w-full text-center text-white inline-block text-sm align-baseline">
                Back to Profile
              </Link>
            </form>
          </div>

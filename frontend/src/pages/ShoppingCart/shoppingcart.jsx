        ...
        <MDBCol md="8">
          ...
          <div className="wholecart">
            {orders.filter((item) => item.quantity > 0).map((item) => (
              ...
              <MDBRow> 
                <MDBCol lg="3" md="12" className="mb-4 mb-lg-0 shopcartpicture">
                  <MDBRipple rippleTag="div" rippleColor="light"
                    ...
                    <img
                      ...
                      className="w-100" />
                    <a href="#!">
                      <div className="mask axsize">
                      </div>
                    </a>
                  </MDBRipple>
                </MDBCol>
                <MDBCol lg="5" md="6" className=" mb-4 mb-lg-0 shopcartinfo">
                  <p>
                ...
                <MDBCol lg="4" md="6" className="mb-4 mb-lg-0">
                  ...
                  <p className="text-start text-md-center shopcartprice">
                    <strong>Price: {item.totalCost}</strong>
                  </p>
